    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm">
                ...
                <button className="w-full text-blue-500 border rounded-md py-2 flex items-center justify-center gap-2 text-sm hover:bg-gray-100 transition">
                    <FaGoogle /> Login with Google
                </button>

                <button className="w-full  border rounded-md py-2 flex items-center justify-center gap-2 text-sm mt-2 hover:bg-gray-100 transition">
